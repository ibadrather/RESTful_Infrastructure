...
class VehicleDataManager:
    ...
    def fetch_all_sensor_data_for_vehicle(self, vehicle_serial: str, session: Session):
        ...
        return self.sensor_repo.get_all_sensor_data_for_vehicle(vehicle_serial=vehicle_serial, session=session)
    ...
    def retrieve_all_vehicle_serial_numbers(self, session: Session) -> List[str]:
        ...
        return self.vehicle_status_repo.get_all_vehicles(session)
